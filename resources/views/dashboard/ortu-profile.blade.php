...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
        <h3 class="text-base font-bold text-slate-600 uppercase tracking-wider mb-4">
            <i class="fa-solid fa-child mr-2 text-indigo-500"></i>Data Anak
        </h3>
        @if($student)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Nama Anak</p>
                ...
                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <p class="font-bold text-slate-700">{{ $student->nisn ?? '-' }}</p>
                </div>
        ...
        @else
            <p class="text-slate-400 text-sm font-medium">Belum ada data anak yang terhubung dengan akun ini.</p>
        @endif
    </div>
</div>
@endsection